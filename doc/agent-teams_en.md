...
For the complete specification of all 19 tools (parameters, return values, permissions, validation constraints), see [MCP Orchestrator Tool Reference](mcp-orchestrator_en.md).
