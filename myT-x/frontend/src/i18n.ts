...
const EN_TRANSLATIONS: Record<string, string> = {
    ...
    "viewer.diffReview.panePlaceholder": "Pane...",
    "viewer.diffReview.selectPaneFirst": "Select a pane first",
    "viewer.diffReview.selectTargetPane": "Select target pane",
    "viewer.diffReview.send": "Send",
    "viewer.diffReview.sending": "Sending...",
    "viewer.diffReview.sendToPane": "Send diff review text to pane",
    "viewer.diffReview.commentCountLabel": "{count} review comment{plural}",
    "viewer.diffReview.clear": "Clear",
    "viewer.diffReview.clearComments": "Clear {count} review comment{plural} in this session",
    "viewer.diffReview.clearConfirm": "{label}\n\nThis cannot be undone.",
    "viewer.diffReview.registerToSingleTaskRunner": "Register to Single Task Runner",
    "viewer.diffReview.registerToSingleTaskRunnerTitle": "Register review comments to Single Task Runner",
    "viewer.diffReview.registeringToSingleTaskRunner": "Registering...",
    "viewer.diffReview.notification.sentComments": "Sent {count} review comment{plural}.",
    "viewer.diffReview.notification.sentReview": "Sent diff review.",
    "viewer.diffReview.notification.registeredTasks": "Registered {count} review task{plural}.",
    "viewer.diffReview.notification.partialRegisteredTasks": "Registered {count} review task{plural} before registration failed. Remaining comments stayed in the diff review.",
    "viewer.diffReview.error.sendFailed": "Failed to send review.",
    "viewer.diffReview.error.registerFailed": "Failed to register review tasks.",
    "viewer.diffReview.sendDialog.commentsLabel": "Review comments",
    "viewer.diffReview.sendDialog.delete": "Delete",
    "viewer.diffReview.sendDialog.description": "Review and edit the diff review text before sending.",
    "viewer.diffReview.sendDialog.discardConfirm": "Discard unsent diff review draft?\n\nThis cannot be undone.",
    "viewer.diffReview.sendDialog.done": "Done",
    "viewer.diffReview.sendDialog.edit": "Edit",
    "viewer.diffReview.sendDialog.emptyCommentError": "Enter comment text or delete this row.",
    "viewer.diffReview.sendDialog.messageLabel": "Optional message",
    "viewer.diffReview.sendDialog.messagePlaceholder": "Message to send to the pane...",
    "viewer.diffReview.sendDialog.noComments": "No comments are included in this send.",
    "viewer.diffReview.sendDialog.targetPane": "Target: {paneId}",
    "viewer.diffReview.sendDialog.title": "Send Review",
    "viewer.diff.discardConfirm.aria": "Confirm discard",
    "viewer.diff.discardConfirm.message": "Discard changes to {filePath}?",
    "viewer.diff.discardConfirm.warning": "This cannot be undone.",
    "viewer.diff.discardConfirm.cancel": "Cancel",
    "viewer.diff.discardConfirm.discard": "Discard",
    "viewer.sessionMemo.title": "Session Memo",
    "viewer.sessionMemo.noSession": "Select a terminal session to edit its memo.",
    "viewer.sessionMemo.loading": "Loading memo...",
    "viewer.sessionMemo.placeholder": "Write notes for this session...",
    "viewer.sessionMemo.textarea": "Session memo",
    "viewer.sessionMemo.unsaved": "Unsaved",
    "viewer.sessionMemo.saved": "Saved",
    "viewer.sessionMemo.saving": "Saving...",
    "viewer.sessionMemo.save": "Save",
    "viewer.sessionMemo.refresh": "Reload session memo",
    "viewer.sessionMemo.dismiss": "Dismiss",
    "viewer.sessionMemo.notification.saved": "Session memo saved.",
    "viewer.sessionMemo.error.load": "Failed to load session memo.",
    "viewer.sessionMemo.error.save": "Failed to save session memo.",
    ...
    "menu.search": "Search... ({shortcut})",
    "menu.search.aria": "Open command palette",
    ...
    "settings.validation.viewerShortcut.reserved": "Duplicated with reserved shortcut {shortcut} ({label}).",
    ...
    "quickSearch.aria.dialogLabel": "Command Palette",
    "quickSearch.placeholder": "Search sessions, viewers, commands, or templates...",
    "quickSearch.executing": "Running...",
    "quickSearch.aria.resultsLabel": "Search results",
    "quickSearch.empty": "No results",
    "quickSearch.group.session": "Session",
    "quickSearch.group.command": "Command",
    "quickSearch.group.viewer": "Viewer",
    "quickSearch.group.template": "Template",
    "quickSearch.group.taskScheduler": "Task Scheduler",
    "quickSearch.operation.activateSession": "Activate session: {sessionName}",
    "quickSearch.command.newSession": "New Session",
    "quickSearch.command.openSettings": "Open Settings",
    "quickSearch.command.toggleViewerSidebarMode": "Toggle Docked Viewer",
    "quickSearch.command.splitPaneVertical": "Split Pane Vertically",
    "quickSearch.command.splitPaneHorizontal": "Split Pane Horizontally",
    "quickSearch.command.openViewer": "Open {label}",
    "quickSearch.command.insertTemplateDefaultName": "Untitled Template",
    "quickSearch.command.openTaskTemplateDraft": "Open Task Template Draft: {name}",
    ...
    "terminalSearch.results.title": "Search results",
    "terminalSearch.results.limitExceededTitle": "Search results (match limit exceeded)",
    "viewer.preview.loading.mermaid": "Loading Mermaid preview...",
    "viewer.preview.loading.swagger": "Loading Swagger preview...",
    "viewer.preview.loading.sqlite": "Loading SQLite preview...",
    "viewer.preview.loading.graphviz": "Loading Graphviz preview...",
    "viewer.preview.loading.markmap": "Loading Markmap preview...",
    "viewer.preview.loading.wavedrom": "Loading WaveDrom preview...",
    "viewer.preview.loading.vegaLite": "Loading Vega-Lite preview...",
    "viewer.preview.loading.vega": "Loading Vega preview...",
    "viewer.swagger.error.empty": "Swagger preview requires a non-empty document.",
    "viewer.swagger.error.topLevelObject": "Swagger preview requires a top-level object document.",
    "viewer.swagger.error.openapiRequired": "Swagger preview requires a top-level openapi or swagger field.",
    "viewer.swagger.error.parseFailed": "Failed to parse Swagger document.",
    "viewer.swagger.error.loadFailed": "Failed to load Swagger preview.",
    "viewer.swagger.loading": "Loading Swagger preview...",
    "viewer.swagger.tryItOut.hint": "Request execution stays disabled until you enable Try it out for this preview.",
    "viewer.swagger.tryItOut.enable": "Enable Try it out",
    "viewer.swagger.tryItOut.disable": "Disable Try it out",
    "viewer.vega.error.renderFailed": "Failed to render Vega chart.",
    "viewer.vega.error.empty": "Vega specification is empty.",
    "viewer.vega.error.objectRequired": "Vega specification must be a JSON object.",
    "viewer.vega.loading": "Rendering Vega chart...",
    "viewer.vega.actions.openMenu": "Actions",
    "viewer.vega.actions.exportPng": "Export as PNG",
    "viewer.vega.actions.exportSvg": "Export as SVG",
    "viewer.vega.actions.source": "View Source",
    "viewer.vega.actions.compiled": "View Compiled",
    "viewer.vega.actions.editor": "Open in Vega Editor",
    ...
    "viewer.shortcuts.duplicate": "Shortcut \"{shortcut}\" is duplicated between \"{ownerA}\" and \"{ownerB}\"",
    "viewer.shortcuts.reserved": "Shortcut \"{shortcut}\" is reserved by \"{label}\"",
    ...
    "viewer.diff.refresh": "Refresh diff",
    "viewer.diff.close": "Close diff",
    ...
    "viewer.fileTree.refresh": "Refresh file tree",
    ...
    "viewer.fileContent.showSourceWithShortcut": "Show source ({shortcut})",
    "viewer.fileContent.showPreview": "Show preview",
    "viewer.fileContent.showPreviewWithShortcut": "Show preview ({shortcut})",
    ...
    "viewer.fileContent.reload": "Reload file",
    ...
    "viewer.taskScheduler.error.noActiveSession": "No active session",
    "viewer.taskScheduler.unsaved.title": "Unsaved Settings",
    "viewer.taskScheduler.unsaved.message": "Leave without saving these scheduler settings?",
    "viewer.taskScheduler.unsaved.discard": "Discard Changes",
    "viewer.taskScheduler.unsaved.genericTitle": "Unsaved Changes",
    "viewer.taskScheduler.unsaved.genericBackMessage": "Leave without saving your task scheduler changes?",
    "viewer.taskScheduler.unsaved.genericCloseMessage": "Close without saving your task scheduler changes?",
    "viewer.taskScheduler.unsaved.genericDiscard": "Discard Changes",
    "viewer.taskScheduler.unsaved.genericDiscardAndClose": "Discard and Close",

    "viewer.orchestratorTeams.label": "Teams",
    "viewer.orchestratorTeams.title": "Teams",
    "viewer.orchestratorTeams.mcpOnlyNote": "(Orchestrator MCP only)",
    "viewer.orchestratorTeams.dismiss": "Dismiss",
    "canvas.unregisteredBadge": "Unregistered",
    "canvas.registerPaneAria": "Register pane",
    "canvas.registerPaneAction": "+ Register",
